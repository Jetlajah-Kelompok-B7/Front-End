  ...
  return (
    <div>
      ...
      <div className="flex justify-center mb-10">
        <div className="flex flex-col w-[936px] h-auto p-10 border-[2px] rounded-3xl shadow-lg shadow-[#64CCC5]/20 mt-[47px]">
          <h1 className="poppins-bold">Akun</h1>
          <button>
            <div className="flex items-center text-white text-left px-[16px] mx-5 mt-[32px] w-auto h-[55px] bg-[#04364A] hover:bg-[#142a32] rounded-xl gap-[8px]">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
          ...
          <div className="flex mx-5 mt-[61px] gap-5">
            <div className="flex flex-col">
              <button>
                <ul className="flex items-center gap-2 border shadow-lg hover:border-2 hover:bg-slate-100 overflow-hidden rounded-md px-2 py-y w-[328px] h-[50px]">
                  <li>
                    <svg
                      width="24"
                      height="24"
              ...
              <button>
                <ul className="flex items-center gap-2 border shadow-lg hover:border-2 hover:bg-slate-100 overflow-hidden rounded-md px-2 py-4 w-[328px] h-[50px] mt-2">
                  <li>
                    <svg
                      width="24"
                      height="24"
                  ...
                  >
                    ...
                    <AccordionBody>
                      <div className="flex flex-col">
                        ...
                        <input
                          type="text"
                          className="block w-[100%] rounded-md border-0 py-1.5 pl-4 pr-6 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#64CCC5] sm:text-sm sm:leading-6"
                        ...
                        <div className="flex justify-center">
                          <button className="py-[8px] px-[23.5px] text-white bg-[#053B50] rounded-lg w-[100px] h-[32px] flex justify-center items-center">
                            Lanjutkan
                          </button>
                        </div>
                      </div>
